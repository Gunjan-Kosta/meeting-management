...
import { LogIn, Key, Mail, Lock, ShieldCheck, UserCheck, Eye } from 'lucide-react';
    ...
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-slate-900/80 border border-slate-700 text-white text-sm rounded-lg focus:ring-2 focus:ring-blue-500 outline-hidden transition-all"
            />
          </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-lg shadow-lg shadow-blue-600/30 flex items-center justify-center space-x-2 transition-all disabled:opacity-50 cursor-pointer"
        >
          {loading ? (
      ...
      <div className="mt-8 pt-6 border-t border-slate-700/80">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
          <button
            ...
            className="px-2.5 py-2 bg-slate-700/60 hover:bg-slate-700 text-slate-200 text-xs font-medium rounded-lg border border-slate-600 flex items-center justify-center space-x-1 transition-all"
          >
      ...
      {showForgotPassword && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-xs">
          <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 max-w-sm w-full">
            <h4 className="text-base font-bold text-white mb-2">Password Recovery</h4>
