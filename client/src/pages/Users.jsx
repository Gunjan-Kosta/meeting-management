  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Users & Role Access Management</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">Provision official user accounts, assign departments, and manage roles.</p>
        </div>
        <button
